...
class AVO_EXPORT Vector2 {
 public:
   ...
   *             specified vector.
   * \param[in]  other  The vector with which the dot product should be
   *                    computed.
  ...
  /**
   * \brief      Computes the scalar multiplication of this vector with
   *             the specified scalar value.
   * \param[in]  scalar  The scalar value with which the scalar multiplication
   *                     should be computed.
   * \return     The scalar multiplication of this vector with a
   ...
   *             scalar value.
   * \param[in]  scalar  The scalar value with which the scalar division should
   *                     be computed.
  ...
  /**
   * \brief      Computes the vector sum of this vector with the
   *             specified vector.
  ...
  /**
   * \brief      Sets the value of this vector to the vector difference of
   *             itself with the specified vector.
   * \param[in]  other  The vector with which the vector difference should be
   *                    computed.
   * \return     A reference to this vector.
   */
 ...
 */
AVO_EXPORT inline float abs(const Vector2 &vector) {
 ...
 */
AVO_EXPORT inline float absSq(const Vector2 &vector) { return vector * vector; }
 ...
 */
AVO_EXPORT inline float det(const Vector2 &vector1, const Vector2 &vector2) {
 ...
 */
AVO_EXPORT inline Vector2 normalize(const Vector2 &vector) {
 ...
 */
AVO_EXPORT inline Vector2 operator*(float scalar, const Vector2 &vector) {
 ...
 *             output stream.
 * \param[in]  stream  The output stream into which the two-dimensional vector
 *                     should be inserted.
